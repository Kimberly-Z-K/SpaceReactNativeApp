    ...
    <ScrollView style={styles.container}>
        ...
        />
          ...
          <View style={styles.icons}>
            <Icon name='person-outline' size={30} color='white' onPress={()=>navigation.navigate('Profile')}/>
            <Icon name="chat" size={30} color="white" onPress={()=>navigation.navigate('Notes')} />
            <Icon name="home" size={30} color="white"  onPress={()=>navigation.navigate('GlobeView')}/> 
          </View>
